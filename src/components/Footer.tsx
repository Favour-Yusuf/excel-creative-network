      ...
      <div className="max-w-7xl mx-auto py-16 px-6 md:px-12 grid md:grid-cols-3 gap-16">
        ...
        <div>
          ...
          <p className="text-sm opacity-80 leading-relaxed">
            ...
            Plumbing, Fabrication, and Construction solutions with engineering excellence,
            safety compliance, and unmatched technical expertise.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="space-y-4 text-sm opacity-80">
            ...
            <div className="flex items-start gap-3">
              ...
              <span>
                14 Marine Road, Apapa Industrial Zone,
                Lagos, Nigeria.
              </span>
            </div>
          </div>
